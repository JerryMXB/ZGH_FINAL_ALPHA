...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      function PAddRedoAll(){
    	  window.location.href='PManageAdd.do';
      };
      function ReturnMeum(){
  ...
  <body>
    <div id="base" class="">
      ...
      <form name="Wmodel" action="PMAddConfirm.do" method="post">
      ...
      <div id="u5" class="ax_text_field">
        <input id="u5_input" type="text" value="" name="mname"/>
      </div>
      ...
      <div id="u19" class="ax_text_field">
        <input id="u19_input" type="text" value="" name="mnation"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u20" class="ax_text_field">
        <input id="u20_input" type="text" value="" name="mworkfield"/>
      </div>
      
      <!-- Unnamed (Text Field) -->
      <div id="u133" class="ax_text_field">
        <input id="u133_input" type="text" value=""name="mbirthdate"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u134" class="ax_text_field">
        <input id="u134_input" type="text" value=""name="mbirthdate"/>
      </div>
      ...
      <div id="u57" class="ax_text_field">
        <input id="u57_input" type="text" value=""name="mpolstat"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u58" class="ax_text_field">
        <input id="u58_input" type="text" value=""name="mjob"/>
      </div>

  
      <!-- Unnamed (Text Field) -->
      <div id="u62" class="ax_text_field">
        <input id="u62_input" type="text" value=""name="mid"/>
      </div>
      
      <!-- Unnamed (Text Field) -->
      <div id="u67" class="ax_text_field">
        <input id="u67_input" type="text" value=""name="mtel"/>
      </div>
      <!-- Unnamed (Text Field) -->
      <div id="u126" class="ax_text_field">
        <input id="u126_input" type="text" name="mexhonor"value=""/>
      </div>
      
      
      <!-- Unnamed (Text Field) -->
      <div id="u132" class="ax_text_field">
        <input id="u132_input" type="text" value=""name="mexhonorcomp"/>
      </div>
      
      <!-- Unnamed (Text Field) -->
      <div id="u44" class="ax_text_field">
        <input id="u44_input" type="text" value=""name="mhealth"/>
      </div>
      
      <!-- Unnamed (Text Field) -->
      <div id="u47" class="ax_text_field">
        <input id="u47_input" type="text" value=""name="mfamily"/>
      </div>
      
       <!-- Unnamed (Text Field) -->
      <div id="u84" class="ax_text_field">
        <input id="u84_input" type="text" value=""name=""/>
      </div>
      
      
      <!-- Unnamed (Text Field) -->
      <div id="u87" class="ax_text_field">
        <input id="u87_input" type="text" name="mdate"value=""/>
      </div>
      
      <!-- Unnamed (Text Field) -->
      <div id="u96" class="ax_text_field">
        <input id="u96_input" type="text" value=""name="mhonorcomp"/>
      </div>
      
      
      <!-- Unnamed (Text Field) -->
      <div id="u102" class="ax_text_field">
        <input id="u102_input" type="text" value=""name="mdocnumber"/>
      </div>
      
      
      <!-- Unnamed (Text Field) -->
      <div id="u114" class="ax_text_field">
        <input id="u114_input" type="text" name="mtreat"value=""/>
      </div>
      
       <!-- Unnamed (Text Field) -->
      <div id="u117" class="ax_text_field">
        <input id="u117_input" type="text" value=""name="mevent"/>
      </div>
     
      
      <!-- Unnamed (Text Field) -->
      <div id="u123" class="ax_text_field">
        <input id="u123_input" type="text" value=""name="mhonorbasis"/>
      </div>
      ...
      <!-- 2 (HTML Button) -->
      <div id="u136" class="ax_html_button" data-label="2" onclick="PMAddConfirmsubmit()">
        <input id="u136_input" type="submit" value="确认"/>
      </div>


      <!-- 3 (HTML Button) -->
      <div id="u137" class="ax_html_button" data-label="3"onclick="PAddRedoAll()">
