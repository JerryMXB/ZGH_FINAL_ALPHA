...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      function CAddConfirm(){
    	  window.location.href='AffrimConfrimed.do';
      };
      function ReturnMeum(){
  ...
  <body>
    <div id="base" class="">
 	...
 	<form name="Cmodel" action="CMASaveSumbit.do" method="post">
 	   
 	   
 	   
      <!-- Unnamed (Droplist) -->
      <div id="u18" class="ax_droplist" >
        <select id="u18_input" name="cworkfield">
      ...
      <div id="u2" class="ax_checkbox">
        ...
        <input id="u2_input" type="radio" value="全国五一劳动奖状单位" name="ctitle"/>
      </div>
      ...
      <div id="u4" class="ax_checkbox">
        ...
        <input id="u4_input" type="radio" value="四川省五一劳动奖状单元" name="ctitle"/>
      </div>
      ...
      <div id="u6" class="ax_checkbox">
        ...
        <input id="u6_input" type="radio" value="全国工人先锋号" name="ctitle"/>
      </div>
      ...
      <div id="u8" class="ax_checkbox">
        ...
        <input id="u8_input" type="radio" value="四川省工人先锋号" name="ctitle"/>
      </div>
   ...
   <!-- Unnamed (Text Field) -->
      <div id="u14" class="ax_text_field">
        <input id="u14_input" type="text" name="cname"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u15" class="ax_text_field">
        <input id="u15_input" type="text" name="cdate"/>
      </div>
      ...
      <div id="u23" class="ax_text_field">
        <input id="u23_input" type="text" value=""name="ctel"/>
      </div>

	  <!-- Unnamed (Text Field) -->
      <div id="u41" class="ax_text_field">
        <input id="u41_input" type="text" value=""name="cevent"/>
      </div>
...
<!-- Unnamed (Shape) -->
	...
	<!-- Unnamed (Shape) -->
      ...
      <div id="u48" class="ax_html_button" data-label="1">
        <input id="u48_input" type="submit" value="保存" onclick="CAddSaveSumbit()"/>
      </div>
