...
<html>
  <head>
    ...
    <link href="files/affirmconfirmed/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- 1 (HTML Button) -->
      <div id="u7" class="ax_html_button" data-label="1"onclick="ReturnInfoManage()">
        <input id="u7_input" type="submit" value="返回"/>
      </div>
    </div>
  </body>
</html>
