...
<html>
  <head>
    ...
    <link href="files/querysysid/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
<form name="QuerySysId1"action="<%=path %>/QuerySysIdGo.do" method="post">
      <!-- Unnamed (Text Field) -->
      <div id="u0" class="ax_text_field">
        <input id="u0_input" type="text" value=""name="mid"/>
      </div>
</form>
      <!-- Unnamed (Shape) -->
      ...
      <div id="u3" class="ax_paragraph">
        ...
        <div id="u4" class="text">
          <p><span>请输入</span><span>系统</span><span>编号</span></p>
        </div>
      </div>
      ...
      <div id="u10" class="ax_image" data-label="meun"onclick="window.location.href='Meun.do'" style="cursor:pointer">
        <img id="u10_img" class="img " src="images/querybasicinfo/meun_u18.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u12" class="ax_image" data-label="QueryAndSta"onclick="window.location.href='query.do'" style="cursor:pointer">
        <img id="u12_img" class="img " src="images/querybasicinfo/meun_u18.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_image" data-label="QueryAdvIndInfo"onclick="window.location.href='QueryAdvIndInfo.do'" style="cursor:pointer">
        <img id="u14_img" class="img " src="images/querybasicinfo/queryadvindinfo_u22.png"/>
        <!-- Unnamed () -->
      ...
      <!-- SysId (Image) -->
      <div id="u16" class="ax_image" data-label="SysId">
        <img id="u16_img" class="img " src="images/querybasicinfo/meun_u18.png"/>
        <!-- Unnamed () -->
      ...
      <!-- go (Image) -->
      <div id="u18" class="ax_image" data-label="go"onclick="document.QuerySysId1.submit()" style="cursor:pointer">
