...
<html>
  <head>
    ...
    <link href="files/querydeathstate/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_paragraph">
        ...
        <div id="u1" class="text">
          <p><span>请输入</span><span>死亡状况</span></p>
        </div>
      </div>
...
<form name="QueryDeathStaGo"action="<%=path %>/QueryDeathStaGo.do" method="post">
      <!-- Unnamed (Droplist) -->
      <div id="u4" class="ax_droplist">
        <select id="u4_input"name="mstat">
          <option value="dead">死亡</option>
          <option selected value="notdead">未死亡</option>
        </select>
      </div>
</form>
      <!-- Unnamed (Image) -->
      ...
      <div id="u10" class="ax_image" data-label="meun"onclick="window.location.href='Meun.do'" style="cursor:pointer">
        <img id="u10_img" class="img " src="images/querydeathstate/meun_u10.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u12" class="ax_image" data-label="QueryAndSta"onclick="window.location.href='query.do'" style="cursor:pointer">
        <img id="u12_img" class="img " src="images/querydeathstate/meun_u10.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_image" data-label="QueryAdvIndInfo"onclick="window.location.href='QueryAdvIndInfo.do'" style="cursor:pointer">
        <img id="u14_img" class="img " src="images/querydeathstate/queryadvindinfo_u14.png"/>
        <!-- Unnamed () -->
      ...
      <!-- DeathSta (Image) -->
      <div id="u16" class="ax_image" data-label="DeathSta">
        <img id="u16_img" class="img " src="images/querydeathstate/meun_u10.png"/>
        <!-- Unnamed () -->
      ...
      <!-- go (Image) -->
      <div id="u18" class="ax_image" data-label="go"onclick="document.QueryDeathStaGo.submit()" style="cursor:pointer">
