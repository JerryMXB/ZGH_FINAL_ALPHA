...
<html>
  <head>
    ...
    <link href="files/queryhonor/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
<form name="QueryAdvIndhonorInfo"action="<%=path %>/QueryHonorGo.do" method="post">
      <!-- Unnamed (Text Field) -->
      <div id="u0" class="ax_text_field" >
        <input id="u0_input" type="text" value=""name="mtitle"/>
      </div>
 </form>
      <!-- Unnamed (Shape) -->
      ...
      <!-- go (Image) -->
      <div id="u18" class="ax_image" data-label="go"onclick="document.QueryAdvIndhonorInfo.submit()" style="cursor:pointer">
