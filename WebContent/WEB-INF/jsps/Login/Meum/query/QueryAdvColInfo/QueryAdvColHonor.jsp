...
<html>
  <head>
    ...
    <link href="files/queryhonor_1/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_paragraph">
        ...
        <div id="u1" class="text">
          <p><span>请输入</span><span>荣誉称号</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (Text Field) -->
        <form name="QueryCmodelHonorGo"action="<%=path %>/QueryCmodelHonorGo.do" method="post">
      <div id="u4" class="ax_text_field">
        <input id="u4_input" type="text" value="" name="ctitle"/>
      </div>
</form>
      <!-- Unnamed (Image) -->
      ...
      <div id="u10" class="ax_image" data-label="meun"onclick="window.location.href='Meun.do'" style="cursor:pointer">
        <img id="u10_img" class="img " src="images/queryhonor_1/meun_u10.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u12" class="ax_image" data-label="QueryAndSta"onclick="window.location.href='query.do'" style="cursor:pointer">
        <img id="u12_img" class="img " src="images/queryhonor_1/meun_u10.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_image" data-label="QueryAdvColInfo"onclick="window.location.href='QueryAdvColInfo.do'" style="cursor:pointer">
        <img id="u14_img" class="img " src="images/queryhonor_1/queryadvcolinfo_u14.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Honor (Image) -->
      <div id="u16" class="ax_image" data-label="Honor">
        <img id="u16_img" class="img " src="images/queryhonor_1/honor_u16.png"/>
        <!-- Unnamed () -->
      ...
      <!-- GO (Image) -->
      <div id="u18" class="ax_image" data-label="GO"onclick="document.QueryCmodelHonorGo.submit()" style="cursor:pointer">
        <img id="u18_img" class="img " src="images/querybasicinfo_1/go_u13.png"/>
        <!-- Unnamed () -->
