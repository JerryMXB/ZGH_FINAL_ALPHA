...
<html>
  <head>
    ...
    <link href="files/datarestoration/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
      ...
      function datainput(){
    	  ...
    	  filepath=document.getElementsByName("filepath");
        	  ...
        	  window.location.href=("Userexceltodb.do?filepath="+filepath[0].value);
      }
    </script>
  </head>
  <body>
    ...
    <!-- Unnamed (Text Field) -->
      <div id="u26" class="ax_text_field">
        <input type="file" id="u26_input" name=filepath>
      </div>
      ...
      <div id="u1" class="ax_paragraph">
        ...
        <div id="u2" class="text">
          <p><span>点击浏览，选择还原文件，即可还原备份。</span></p>
        </div>
      </div>
      ...
      <div id="u12" class="ax_image">
        <img id="u12_img" class="img " src="images/userinfmanage/u40.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_image">
        <img id="u14_img" class="img " src="images/userinfmanage/u42.png"/>
        <!-- Unnamed () -->
      ...
      <!-- czshujubeifenbutton (Shape) -->
              <!-- Unnamed () -->
                    <!-- czshujubeifentxt (Shape) -->
                            <!-- Unnamed () -->
      <!--  
      <div id="u16" class="ax_shape" data-label="czshujubeifenbutton">
        <img id="u16_img" class="img " src="images/login/u32.png" />
      ...
      <div id="u18" class="ax_paragraph" data-label="czshujubeifentxt"onclick="datainput()">
