...
<html>
  <head>
    ...
    <link href="files/selectuser/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u37" class="ax_text_field">
        <input id="u37_input" type="hidden" value="Select" name="Where"/>
      </div>
      ...
      <div id="u5" class="ax_paragraph">
        <img id="u5_img" class="img " src="resources/images/transparent.gif" name="Where"/>
        <!-- Unnamed () -->
      ...
      <!-- cztoSelSalutbutton (Shape) -->
      <div id="u15" class="ax_shape" data-label="cztoSelSalutbutton" onclick="Select()">
      ...
      <!-- cztoSelSaluttxt (Shape) -->
      <div id="u17" class="ax_paragraph" data-label="cztoSelSaluttxt" onclick="Select()">
