...
<html>
  <head>
    ...
    <link href="files/alteruser/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_flow_shape">
        ...
        <!-- Unnamed () -->
        <div id="u1" class="text" onclick="window.location.href='AlterUser.do'">
          <p><span>修改用户</span></p>
        </div>
      </div>
      ...
      <div id="u2" class="ax_paragraph">
        ...
        <div id="u3" class="text">
          <p><span>筛选要</span><span>修改</span><span>的用户，按：</span></p>
        </div>
      </div>
      ...
      <div id="u37" class="ax_text_field">
        <input id="u37_input" type="hidden" value="Alter" name="Where"/>
      </div>
      ...
      <!-- cztoAlterSalutbuton (Shape) -->
      <div id="u15" class="ax_shape" data-label="cztoAlterSalutbuton" onclick="Select()">
      ...
      <!-- cztoAlterSaluttxt (Shape) -->
      <div id="u17" class="ax_paragraph" data-label="cztoAlterSaluttxt" onclick="Select()">
      ...
      <div id="u23" class="ax_image" data-label="toUserManagere" onclick="window.location.href='UserManage.do'">
      ...
      <div id="u25" class="ax_paragraph" data-label="toUserManageret" onclick="window.location.href='UserManage.do'">
      ...
      <div id="u27" class="ax_flow_shape" data-label="toUserManagedh" onclick="window.location.href='UserManage.do'">
        <img id="u27_img" class="img " src="images/userinfmanage/u19.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u29" class="ax_image">
        <img id="u29_img" class="img " src="images/userinfmanage/u40.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u31" class="ax_flow_shape" data-label="toSysManagedh" onclick="window.location.href='SysManage.do'">
        <img id="u31_img" class="img " src="images/userinfmanage/tosysmanagedh_u17.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u33" class="ax_flow_shape" data-label="toUserInfManagedh" onclick="window.location.href='UserInfManage.do'">
        <img id="u33_img" class="img " src="images/userinfmanage/u19.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u35" class="ax_image">
        <img id="u35_img" class="img " src="images/userinfmanage/u40.jpg"/>
        <!-- Unnamed () -->
