...
<html>
  <head>
    ...
    <link href="files/deleteuser/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u37" class="ax_text_field">
        <input id="u37_input" type="hidden" value="Delete" name="Where"/>
      </div>
      ...
      <!-- cztoDelSalutbutton (Shape) -->
      <div id="u15" class="ax_shape" data-label="cztoDelSalutbutton" onclick="Select()">
      ...
      <!-- cztoDelSaluttxt (Shape) -->
      <div id="u17" class="ax_paragraph" data-label="cztoDelSaluttxt" onclick="Select()">
