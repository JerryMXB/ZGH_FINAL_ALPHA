...
<html>
  <head>
    ...
    <link href="files/backupmanage/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_paragraph">
        ...
        <div id="u1" class="text">
          <p><span>点击“删除备份”可以删除选中备份。</span></p>
        </div>
      </div>

      <!-- Unnamed (List Box) -->
      <div id="u2" class="ax_list_box">
        <select id="u2_input" size="2">
        </select>
      </div>

      <!-- toDataBackupdh (Flow Shape) -->
      <div id="u3" class="ax_flow_shape" data-label="toDataBackupdh" onclick="window.location.href='DataBackup.do'">
      ...
      <div id="u5" class="ax_flow_shape">
        ...
        <div id="u6" class="text">
          <p><span>数据备份</span><span>操作</span></p>
        </div>
      </div>

      <!-- toDataBackupre (Image) -->
      <div id="u7" class="ax_image" data-label="toDataBackupre"onclick="window.location.href='DataBackup.do'">
      ...
      <!-- toDataBackupret (Shape) -->
      <div id="u9" class="ax_paragraph" data-label="toDataBackupret"onclick="window.location.href='DataBackup.do'">
      ...
      <div id="u16" class="ax_image">
        <img id="u16_img" class="img " src="images/sysmanage/u25.jpg"/>
        <!-- Unnamed () -->
      ...
      <!-- czshanchubeifenbutton (Shape) -->
      <div id="u24" class="ax_shape" data-label="czshanchubeifenbutton">
        <img id="u24_img" class="img " src="images/login/u32.png"/>
        <!-- Unnamed () -->
      ...
      <!-- czshanchubeifentxt (Shape) -->
      <div id="u26" class="ax_paragraph" data-label="czshanchubeifentxt">
        <img id="u26_img" class="img " src="resources/images/transparent.gif"/>
        <!-- Unnamed () -->
        <div id="u27" class="text">
          <p><span>删除</span><span>备份</span></p>
        </div>
      </div>
