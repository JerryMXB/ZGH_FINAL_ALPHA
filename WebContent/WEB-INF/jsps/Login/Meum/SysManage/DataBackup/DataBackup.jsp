...
<html>
  <head>
    ...
    <link href="files/databackup/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_paragraph">
        ...
        <div id="u1" class="text">
          <p><span>点击“数据备份”以进行备份，或点击“查询备份”查询已有备份。</span></p>
        </div>
      </div>
      ...
      <div id="u4" class="ax_image">
        <img id="u4_img" class="img " src="images/login/u0.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u8" class="ax_horizontal_line">
        ...
        <img id="u8_line" class="img " src="images/login/u4_line.png" alt="u8_line"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u9" class="ax_image">
        <img id="u9_img" class="img " src="images/sysmanage/u25.jpg"/>
        <!-- Unnamed () -->
      ...
      <!-- czshujubeifenbutton (Shape) -->
      <div id="u11" class="ax_shape" data-label="czshujubeifenbutton">
        <img id="u11_img" class="img " src="images/login/u32.png"/>
        <!-- Unnamed () -->
      ...
      <!-- czshujubeifentxt (Shape) -->
      <div id="u13" class="ax_paragraph" data-label="czshujubeifentxt"onclick="window.location.href('Userdbtoexcel.do')">
      ...
      <!-- cztoBackupManaggebutton (Shape) -->
      <div id="u15" class="ax_shape" data-label="cztoBackupManaggebutton" onclick="window.location.href='BackupManage.do'">
        <img id="u15_img" class="img " src="images/login/u32.png"/>
        <!-- Unnamed () -->
      ...
      <!-- cztoBackupManaggetxt (Shape) -->
      <div id="u17" class="ax_paragraph" data-label="cztoBackupManaggetxt" onclick="window.location.href='BackupManage.do'">
      ...
      <!-- toSysManagere (Image) -->
      <div id="u23" class="ax_image" data-label="toSysManagere" onclick="window.location.href='SysManage.do'">
      ...
      <div id="u25" class="ax_paragraph" data-label="toSysManageret" onclick="window.location.href='SysManage.do'">
