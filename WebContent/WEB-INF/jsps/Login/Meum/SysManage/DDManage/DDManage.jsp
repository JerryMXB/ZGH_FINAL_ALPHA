...
<html>
  <head>
    ...
    <link href="files/ddmanage/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_paragraph">
        ...
        <div id="u1" class="text">
          <p><span>输入</span><span>数据字典名称以</span><span>选择字典管理对象</span><span></span><span>：</span></p>
        </div>
      </div>
      ...
      <div id="u3" class="ax_flow_shape">
        <img id="u3_img" class="img " src="images/userinfmanage/u19.png"/>
        <!-- Unnamed () -->
        <div id="u4" class="text">
          <p><span>数据字典</span><span>管理</span></p>
        </div>
      </div>
      ...
      <div id="u10" class="ax_image">
        <img id="u10_img" class="img " src="images/sysmanage/u25.jpg"/>
        <!-- Unnamed () -->
      ...
      <!-- cztoSubDDManagebutton (Shape) -->
      <div id="u12" class="ax_shape" data-label="cztoSubDDManagebutton" onclick="window.location.href='SubDDManage.do'">
        <img id="u12_img" class="img " src="images/login/u32.png"/>
        <!-- Unnamed () -->
      ...
      <!-- cztoSubDDManagetxt (Shape) -->
      <div id="u14" class="ax_paragraph" data-label="cztoSubDDManagetxt" onclick="window.location.href='SubDDManage.do'">
        <img id="u14_img" class="img " src="resources/images/transparent.gif"/>
        <!-- Unnamed () -->
        <div id="u15" class="text">
          <p><span>&nbsp;&nbsp; </span><span>查询</span></p>
        </div>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u16" class="ax_image">
        <img id="u16_img" class="img " src="images/userinfmanage/u40.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u18" class="ax_image">
        <img id="u18_img" class="img " src="images/userinfmanage/u42.png"/>
        <!-- Unnamed () -->
      ...
      <!-- toSysManagere (Image) -->
      <div id="u20" class="ax_image" data-label="toSysManagere" onclick="window.location.href='SysManage.do'">
      ...
      <div id="u22" class="ax_paragraph" data-label="toSysManageret" onclick="window.location.href='SysManage.do'">
